...
# escriba esto al finalizar este ejercicio-> python 6.resize.py -i ./imagenes/pythonYellow.jpg
...
# en esta linea se define que el ancho de la nueva imagen será de 150 pixeles
...
# teniendo el nuevo radio ya se pueden calcular las nuevas
...
# aqui usamos la posición 0 recordando que la altura se ubica en esta posición
